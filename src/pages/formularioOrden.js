    ...
    <Formik
      ...
      onSubmit={async (values, actions) => {
        ...
        try {
          ...
          doc.text(40, 70, "FECHA DE SOLICITUD:");
          doc.text(200, 70, moment(values.fecha).format(moment.HTML5_FMT.DATE));
          doc.text(40, 85, "VENDEDOR:");
          doc.text(200, 85, values.vendedor);
          doc.text(40, 100, "LOCAL:");
          doc.text(200, 100, values.local);
          doc.text(40, 115, "NOMBRE DEL CLIENTE:");
          doc.text(200, 115, values.nombreCliente);
          doc.text(40, 130, "TELÉFONO:");
          doc.text(200, 130, values.telefono1);
          doc.text(40, 145, "EMAIL:");
          doc.text(200, 145, values.email);
          doc.text(40, 160, "DIRECCIÓN:");
          doc.text(200, 160, values.direccion);
          doc.text(40, 175, "CONTACTO EMERGENCIA:");
          doc.text(200, 175, values.nombreEmergencia);
          doc.text(40, 190, "TELÉFONO EMERGENCIA:");
          doc.text(200, 190, values.telefono2);
          doc.text(40, 205, "EMAIL EMERGENCIA:");
          doc.text(200, 205, values.correoEmergencia);
          doc.setFont("Helvertica", "bold");
          doc.setFillColor(238, 201, 47);
          ...
          doc.text(40, 245, "MARCA:");
          doc.text(200, 245, values.marca);
          doc.text(40, 260, "MODELO:");
          doc.text(200, 260, values.modelo);
          doc.text(40, 275, "AÑO:");
          doc.text(200, 275, values.anio);
          doc.text(40, 290, "CHASIS:");
          doc.text(200, 290, values.chasis);
          doc.text(40, 305, "COLOR:");
          doc.text(200, 305, values.color);
          doc.text(40, 320, "PLACA:");
          doc.text(200, 320, values.placa);
          doc.text(40, 335, "MOTOR:");
          doc.text(200, 335, values.motor);
          doc.setFont("Helvertica", "bold");
          doc.setFillColor(238, 201, 47);
          ...
          doc.text(40, 370, "AÑOS DE SERVICIO:");
          doc.text(200, 370, plan1);
          doc.text(40, 385, "VALOR $:");
          doc.text(200, 385, values.valor);
          doc.text(40, 400, "FINANCIERA:");
          doc.text(200, 400, values.financiera);
          doc.text(40, 415, "FACTURA A NOMBRE DE:");
          doc.text(200, 415, values.facturaNombre);
          doc.text(40, 430, "RUC/CI:");
          doc.text(200, 430, values.ruc);
          doc.setFont("Helvertica", "bold");
          doc.setFillColor(238, 201, 47);
    ...
    >
      {({ handleChange, handleSubmit,setFieldValue, values, isSubmitting }) => (
        <>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  <div className="navbar-nav">
                    <Link
                      className="nav-link"
                      to={"/ordenuser"}
                      state={{ token: token, idUsuario: idUsuario }}
                    >
                      Ordenes
                    </Link>
                  </div>
          ...
          <div
            className="container border border-3 p-5 my-6"
          ...
          >
            ...
            <h3 className="text-center">
              <strong> FORMULARIO DE ORDEN DE ACTIVACIÓN</strong>
            </h3>
            <br></br>
            <Form className="row" onSubmit={handleSubmit}>
              <div className="row">
                ...
                <div className="col-md-4">
                  <label className="form-label fw-bold">
                    <FaUserAlt></FaUserAlt> NOMBRE CLIENTE
                  </label>
                  <input
                    type="label"
              ...
              <div className="row">
                <div className="col-md-4">
                  <label className="form-label fw-bold">
                    <FaUserAlt></FaUserAlt> CONTACTO EMERGENCIA
                  </label>
                  <input
                    type="label"
                    className="form-control"
                    ...
                    onChange={handleChange}
                    value={values.nombreEmergencia}
                  />
                </div>
                <div className="col-md-4">
                  <label className="form-label fw-bold">
                    <FaPhone></FaPhone> TELÉFONO EMERGENCIA
                  </label>
                  <input
                    type="label"
                    className="form-control"
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    value={values.correoEmergencia}
                  />
                </div>
                <div className="col-md-4">
                  <label className="form-label fw-bold">
                    <FaUserTie></FaUserTie> VENDEDOR
                  </label>
                  <input
                    type="label"
                    className="form-control"
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <label className="form-label fw-bold">
                    <FaRegBookmark></FaRegBookmark> MARCA
                  </label>
                  <input
                    type="label"
                    className="form-control"
              ...
              <div className="row justify-content-center">
                ...
                <div className="col-md-4">
                  <Button type="submit" className="btn btn-dark">
                    {" "}
                    {isSubmitting
                      ? "Enviando y descargando....."
                      : "Enviar Orden y Descargar Archivo pdf"}
                  </Button>
                </div>
              </div>
            </Form>
                ...
                <Row>
                  <Col>
                    <p className="text-center">
                      © 2023 Tracker X. Todos los derechos reservados.
                    </p>
                  </Col>
                </Row>
              </Container>
          ...
          <Modal show={show} onHide={handleClose} centered>
            ...
            <Modal.Body>
              <div className="alert alert-info">
                Para solicitar un cambio en la información ingresada -
                0987305823
              </div>
              <div className="alert alert-secondary">
                Para reportar alguna error o solicitar soporte en el ingreso de
                datos - 0983367940
              </div>
            </Modal.Body>
            <Modal.Footer>
          ...
          <Modal show={show2} onHide={handleClose} centered>
            <Modal.Body>
              <div className="alert alert-danger">
                ERROR!! FORMULARIO NO ENVIADO, REVISA LOS DATOS INGRESADOS O
                COMUNICATE A LOS NÚMEROS DE SOPORTE.
              </div>
            </Modal.Body>
            <Modal.Footer>
              <Button variant="secondary" onClick={handleClose}>
